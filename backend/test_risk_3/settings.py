"""
Django settings for test_risk_3 project.
...
WSGI_APPLICATION = 'test_risk_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_risk_3 API",
    "DESCRIPTION": "API documentation for test_risk_3 App",
    "VERSION": "v1",
}
